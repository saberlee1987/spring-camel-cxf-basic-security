package com.saber.spring_webflux_camel_soap_client.controllers;
...
@RestController
@Validated
@Tag(name = "person webflux camel soap client", description = "person webflux camel soap client")
...
public class PersonController {
	...
	public ResponseEntity<Mono<PersonSoapDto>> findPersonByNationalCode(@PathVariable(name = "nationalCode")
	...
	public ResponseEntity<Mono<FindAllResponseDto>> findAllPersons(ServerWebExchange exchange) {
	...
	public ResponseEntity<Mono<AddPersonSoapResponseDto>> addPerson(@RequestBody @NotNull(message = "body is Required") @Valid PersonSoapDto personDto, ServerWebExchange exchange) {
		String correlation = getCorrelation(exchange);
	...
	public ResponseEntity<Mono<UpdatePersonSoapResponseDto>> updatePerson(@RequestBody
	...
	public ResponseEntity<Mono<DeleteSoapPersonDto>> deletePersonByNationalCode(@PathVariable(name = "nationalCode")
																		  @NotBlank(message = "nationalCode is Required")
																		  @Size(min = 10, max = 10, message = "nationalCode must be 10 digit")
																		  @Pattern(regexp = "\\d+", message = "please enter valid nationalCode")
																				  String nationalCode,ServerWebExchange exchange) {
