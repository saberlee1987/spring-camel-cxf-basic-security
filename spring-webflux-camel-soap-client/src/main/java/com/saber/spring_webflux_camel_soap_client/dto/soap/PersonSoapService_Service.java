...
public class PersonSoapService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/SABER/AppData/Local/Temp/tempdir16888966992815803628.tmp/personSoapService_1.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PersonSoapService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/SABER/AppData/Local/Temp/tempdir16888966992815803628.tmp/personSoapService_1.wsdl");
        }
        WSDL_LOCATION = url;
    }
