...
import com.saber.spring_webflux_camel_soap_client.dto.soap.DeletePersonResponse;
...
public class DeletePersonByNationalCodeRoute extends AbstractRestRouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from(String.format("direct:%s", Routes.DELETE_PERSON_ROUTE_GATEWAY))
                ...
                .log("Request for correlation : ${in.header.correlation} , delete person by nationalCode ${in.header.nationalCode}")
