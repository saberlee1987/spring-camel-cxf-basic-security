package com.saber.spring_webflux_camel_rest_client.adviser;


import com.saber.spring_webflux_camel_rest_client.dto.ErrorResponse;
import com.saber.spring_webflux_camel_rest_client.dto.ServiceErrorResponseEnum;
import com.saber.spring_webflux_camel_rest_client.dto.ValidationDto;
...
public class MyExceptionHandler {
	...
	public ResponseEntity<Object> handleGatewayException(GatewayException exception){
		...
		log.error("Error for  correlation : {} , handleGatewayException with statusCode {} ===> {}"
				,exception.getCorrelation()
				,exception.getStatusCode(),exception.getErrorResponse());
