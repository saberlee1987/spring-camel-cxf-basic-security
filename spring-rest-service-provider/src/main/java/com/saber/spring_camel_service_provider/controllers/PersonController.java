...
public class PersonController {
	...
	public ResponseEntity<PersonDto> findByNationalCode(@PathVariable(name = "nationalCode")
		...
		PersonDto response = this.personService.findByNationalCode(nationalCode);
		log.info("Response for findByNationalCode  ====> {}", response);
		return ResponseEntity.ok(response);
	}
	
	@GetMapping(value = "/findAll")
	@Operation(tags = {"findAll"}, summary = "findAll", description = "findAll api", method = "GET")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Success",
	...
	public ResponseEntity<PersonDto> updatePersonByNationalCode(@PathVariable(name = "nationalCode")
		...
		PersonDto response = this.personService.updatePersonByNationalCode(nationalCode, dto);
