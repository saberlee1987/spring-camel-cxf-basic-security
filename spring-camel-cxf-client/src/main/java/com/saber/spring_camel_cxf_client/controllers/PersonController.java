...
public class PersonController {
    ...
    @GetMapping(value = "/findByNationalCode/{nationalCode}", produces = MediaType.APPLICATION_JSON)
    ...
    public ResponseEntity<PersonSoapDto> findPersonByNationalCode(@PathVariable(name = "nationalCode") @NotBlank(message = "nationalCode is Required") @Size(min = 10, max = 10, message = "nationalCode must be 10 digit") @Pattern(regexp = "\\d+", message = "please enter valid nationalCode") String nationalCode) {
